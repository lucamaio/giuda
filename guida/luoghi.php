    ...
    <div class="container">
        ...
        <article class="guide-content" aria-label="Procedura per creare e gestire un luogo">
            <section class="guide-section" aria-labelledby="accesso-luoghi">
                ...
                <?php ps_screenshot_placeholder('Pannello WordPress con la voce Luoghi evidenziata'); ?>
            </section>
            ...
            <section class="guide-section" aria-labelledby="immagine">
                ...
                <?php ps_screenshot_placeholder('Campo immagine principale del luogo con testo alternativo'); ?>
            </section>
            ...
            <section class="guide-section" aria-labelledby="mappa">
                ...
                <?php ps_screenshot_placeholder('Mappa con il segnaposto posizionato sull’ingresso del luogo'); ?>
            </section>
